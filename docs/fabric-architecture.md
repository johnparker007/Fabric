...
and the neutral machine model cover digital inputs, lamps, reels, character, segment, and dot-matrix displays, and PCM
...
4. Verify lamps, reels, character/segment/dot-matrix displays, audio, switches, reset, stop, and restart.
